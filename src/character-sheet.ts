...
class LayoutManager {
    ...
    private applyTextareaHeights(): void {
        if (!this.layout.textareaHeights) return;
    ...
    private initializeTextareaResizeListeners(): void {
...
class CharacterSheet {
    ...
    private updateAll(): void {
        ...
        if (helm) helm.checked = this.data.helm || false;
